  ...
  const cards = [
    {
      ...
      img: "/images/staff/manager.jpg", // Change this if you have a manager image
      reverse: true,
    },
    {
      name: "Smt. Resmi P",
        ...
        {cards.map((person, index) => (
          ...
          >
            ...
            <div className="flex-1 flex flex-col gap-4 text-center md:text-left">
              ...
              <div className="text-font-secondary text-sm sm:text-base leading-relaxed space-y-4 text-justify">
